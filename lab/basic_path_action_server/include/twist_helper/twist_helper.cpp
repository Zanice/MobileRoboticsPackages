...
void TwistCommander::configureTwistCorrectionFactors(double move_speed_factor, double turn_speed_factor) {
	move_speed_factor_ = move_speed_factor;
	turn_speed_factor_ = turn_speed_factor;
}

void TwistCommander::configureTwistCorrectionBuffers(double move_speed_buffer, double turn_speed_buffer) {
