...
class TwistCommander {
	...
	public:
		...
		void configureTwistCorrectionFactors(double move_speed_factor, double turn_speed_factor);
		void configureTwistCorrectionBuffers(double move_speed_buffer, double turn_speed_buffer);
