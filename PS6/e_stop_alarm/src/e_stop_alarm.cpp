...
// node name
const char* NODE_NAME = "e_stop_alarm";
// name of LIDAR scan topic to subscribe to
const char* SCAN_TOPIC_NAME = "/scan";
// name of alarm topic to publish to
const char* ALARM_TOPIC_NAME = "/e_stop_alarm/alarm";
// name of minimum distance topic to publish to
const char* MIN_DIST_TOPIC_NAME = "/e_stop_alarm/min_dist";

const double MIN_SAFE_DIST = 1.5;
